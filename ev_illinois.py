...
# BetUS matchups: (driver_a, driver_b, odds_a, odds_b)
MATCHUPS = [
    ("Christopher Bell",   "Ryan Blaney",       -120, -110),
    ("Christopher Bell",   "Denny Hamlin",      -125, -105),
    ("Christopher Bell",   "Joey Logano",       -140,  110),
    ("Christopher Bell",   "Kyle Larson",       -155,  125),
    ("Ryan Blaney",        "Denny Hamlin",      -120, -110),
    ("Ryan Blaney",        "Joey Logano",       -130,  100),
    ("Ryan Blaney",        "Kyle Larson",       -150,  120),
    ("Denny Hamlin",       "Joey Logano",       -125, -105),
    ("Denny Hamlin",       "Kyle Larson",       -145,  115),
    ("Joey Logano",        "Kyle Larson",       -130,  100),
    ("Chase Briscoe",      "Ty Gibbs",          -125, -105),
    ("Chase Briscoe",      "Tyler Reddick",     -140,  110),
    ("Chase Briscoe",      "William Byron",     -150,  120),
    ("Chase Briscoe",      "Chase Elliott",     -175,  145),
    ("Ty Gibbs",           "Tyler Reddick",     -125, -105),
    ("Ty Gibbs",           "William Byron",     -140,  110),
    ("Ty Gibbs",           "Chase Elliott",     -160,  130),
    ("Tyler Reddick",      "William Byron",     -125, -105),
    ("Tyler Reddick",      "Chase Elliott",     -145,  115),
    ("William Byron",      "Chase Elliott",     -135,  105),
    ("Josh Berry",         "Austin Cindric",    -120, -110),
    ("Josh Berry",         "Bubba Wallace",     -115, -115),
    ("Josh Berry",         "Brad Keselowski",   -175,  145),
    ("Josh Berry",         "Ross Chastain",     -175,  145),
    ("Austin Cindric",     "Bubba Wallace",     -110, -120),
    ("Austin Cindric",     "Brad Keselowski",   -165,  135),
    ("Austin Cindric",     "Carson Hocevar",    -175,  145),
    ("Bubba Wallace",      "Brad Keselowski",   -175,  145),
    ("Bubba Wallace",      "Ryan Preece",       -180,  150),
    ("Ross Chastain",      "Brad Keselowski",   -115, -115),
    ("Ross Chastain",      "Chris Buescher",    -115, -115),
    ("Ross Chastain",      "Carson Hocevar",    -125, -105),
    ("Ryan Preece",        "Carson Hocevar",    -115, -115),
    ("Ryan Preece",        "Chris Buescher",    -105, -125),
    ("Carson Hocevar",     "Chris Buescher",    -105, -125),
    ("Erik Jones",         "Michael McDowell",  -125, -105),
    ("Erik Jones",         "Daniel Suarez",     -125, -105),
    ("Erik Jones",         "Alex Bowman",       -110, -120),
    ("Michael McDowell",   "Daniel Suarez",     -115, -115),
    ("Michael McDowell",   "Alex Bowman",        100, -130),
    ("Daniel Suarez",      "Shane Van Gisbergen", -125, -105),
]
